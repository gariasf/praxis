...
fn generate_gltf_mesh(vertex_count: usize) -> String {
    ...
    let positions_bytes: Vec<u8> = positions.iter()
        .flat_map(|&f| f.to_le_bytes())
        .collect();
    let indices_bytes: Vec<u8> = indices.iter()
        .flat_map(|&i| i.to_le_bytes())
        .collect();
    
    let positions_base64 = base64::Engine::encode(
        &base64::engine::general_purpose::STANDARD,
        &positions_bytes
    );
    let indices_base64 = base64::Engine::encode(
        &base64::engine::general_purpose::STANDARD,
        &indices_bytes
    );
  ...
  "accessors": [
    ...
    {{
      ...
      "type": "SCALAR"
        ...
        positions_base64, positions_len,
        indices_base64, indices_len,
        positions_len, indices_len,
