...
- **Learning**: [Vulkan Shader Resource Binding](https://www.khronos.org/blog/vulkan-shader-resource-binding), "GPU Zen" series
...
- **Learning**: "Real-Time Rendering 4th Edition", Vulkan Best Practices
...
- **Learning**: [Vulkan Memory Management](https://gpuopen.com/learn/vulkan-memory-management/)
...
- [ ] Resource tracking
- **Learning**: [Vulkan Debug Tools](https://www.khronos.org/registry/vulkan/specs/1.3-extensions/man/html/VK_EXT_debug_utils.html)
...
- [ ] Indirect drawing
- [ ] Occlusion culling
- **Learning**: "Game Engine Architecture" by Jason Gregory
...
- **Learning**: [Vulkan Multi-threading](https://www.khronos.org/assets/uploads/developers/library/2016-vulkan-devday-uk/7-Threading-in-Vulkan.pdf)
