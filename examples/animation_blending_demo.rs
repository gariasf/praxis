...
use praxis_scene::{
    AdditiveBlendNode, AnimationBlender, AnimationClip, AnimationLayer, BlendNode1D, BlendNode2D,
    Bone, BoneMask, LayerBlendMode, Skeleton,
};
...
fn main() {
    ...
    demo_cross_fade(&skeleton, idle_clip.clone(), walk_clip.clone());
    ...
    demo_layered_animation(&skeleton, walk_clip.clone(), wave_clip);
