...
pub fn ragdoll_activation_system(mut ragdoll_query: Query<&mut Ragdoll>) {
    let dt = 0.016;
...
pub fn ragdoll_joint_system(
    ...
    for (entity, ragdoll_joint) in &joint_query {
        ...
        let joint: GenericJoint = match ragdoll_joint.joint_type {
            RagdollJointType::Ball => SphericalJointBuilder::new()
            ...
            RagdollJointType::Hinge => {
                ...
                RevoluteJointBuilder::new(axis)
                    ...
                    .local_anchor2(local_anchor2)
                    .limits([
                        ragdoll_joint.limits.min_angle,
                        ragdoll_joint.limits.max_angle,
                    ])
                    .build()
                    .into()
            }
