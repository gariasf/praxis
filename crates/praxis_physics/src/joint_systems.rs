...
use crate::joints::{
    BallJoint, HingeJoint, SliderJoint, 
    FixedJoint as PraxisFixedJoint, 
...
#[allow(clippy::needless_pass_by_value, clippy::type_complexity, clippy::too_many_lines, unused_variables)]
pub fn sync_joints_system(
    ...
    for (entity, hinge) in &hinge_query {
        ...
        let local_anchor1 = point![hinge.local_anchor1.x, hinge.local_anchor1.y, hinge.local_anchor1.z];
        let local_anchor2 = point![hinge.local_anchor2.x, hinge.local_anchor2.y, hinge.local_anchor2.z];
        let local_axis1 = NaUnit::new_normalize(vector![hinge.local_axis1.x, hinge.local_axis1.y, hinge.local_axis1.z]);
    ...
    for (entity, ball) in &ball_query {
        ...
        let local_anchor1 = point![ball.local_anchor1.x, ball.local_anchor1.y, ball.local_anchor1.z];
        let local_anchor2 = point![ball.local_anchor2.x, ball.local_anchor2.y, ball.local_anchor2.z];
    ...
    for (entity, slider) in &slider_query {
        ...
        let local_anchor1 = point![slider.local_anchor1.x, slider.local_anchor1.y, slider.local_anchor1.z];
        let local_anchor2 = point![slider.local_anchor2.x, slider.local_anchor2.y, slider.local_anchor2.z];
        let local_axis1 = NaUnit::new_normalize(vector![slider.local_axis1.x, slider.local_axis1.y, slider.local_axis1.z]);
        let local_axis2 = NaUnit::new_normalize(vector![slider.local_axis2.x, slider.local_axis2.y, slider.local_axis2.z]);
    ...
    for (entity, fixed) in &fixed_query {
        ...
        let local_anchor1 = point![fixed.local_anchor1.x, fixed.local_anchor1.y, fixed.local_anchor1.z];
        let local_anchor2 = point![fixed.local_anchor2.x, fixed.local_anchor2.y, fixed.local_anchor2.z];
