...
mod post_process_tests {
    use crate::post_process::{PostProcessPass, CopyPass, GrayscalePass};
    use crate::post_process::{BrightnessExtractionPass, GaussianBlurHorizontalPass, GaussianBlurVerticalPass, ToneMapPass};
    ...
    fn test_copy_pass_name() {
        ...
        impl PostProcessPass for MockCopyPass {
            fn execute(
                &mut self,
                _builder: &mut crate::post_process::pass::AutoCommandBufferBuilder<crate::post_process::pass::PrimaryAutoCommandBuffer>,
